...
if 'logged_in' not in st.session_state or not st.session_state['logged_in']:
    ...
    with col2:
        ...
        col1, col2 ,col3,d,e= st.columns(5)
        with col3:
...
# # Increase font size using Markdown
# st.markdown("<h1 style='text-align: center;'>Heading 1</h1>", unsafe_allow_html=True)
# st.markdown("<h2>Heading 2</h2>", unsafe_allow_html=True)
# st.markdown("<p style='font-size: 28px;'>This is a paragraph with increased font size.</p>", unsafe_allow_html=True)

# # Increase font size using Write
# st.write("<h3 style='color: blue; font-size: 28px;'>Heading 3 with increased font size and color.</h3>", unsafe_allow_html=True)
# st.write("<p style='font-size: 28px;'>This is another paragraph with increased font size.</p>", unsafe_allow_html=True)
